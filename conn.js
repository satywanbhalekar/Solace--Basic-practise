...
const queueName = 'QUEUE.FOR.QMAX1'; // Your IBM MQ queue name
const channel = 'QMAX1.TO.QMAX3'; // Your IBM MQ channel name
const host = 'localhost'; // Your IBM MQ host
const port = '5000'; // Your IBM MQ port
...
function TopicSubscriber(solaceModule, topicName) {
    ...
    subscriber.connect = function () {
        ...
        const hostUrl = 'wss://mr-connection-emqbm9dvxgb.messaging.solace.cloud:443';
        const vpnName = 'myfirstservice';
        const username = 'solace-cloud-client';
        const pass = 'thhp2hnens446vcir9cfs7gtnq';
...
const subscriber = new TopicSubscriber(solace, 'tutorial/queue');
subscriber.run();
